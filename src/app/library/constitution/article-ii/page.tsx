...
export const metadata: Metadata = {
  title: `${ARTICLE_II.article} — ${ARTICLE_II.title}`,
  description: `Stankings Group Constitution Vol. I v${CONSTITUTION_VERSION}, ${ARTICLE_II.article}: ${ARTICLE_II.title}`,
  robots: { index: false, follow: false },
};

export default function ConstitutionArticleTwoPage() {
  return (
    <div className="pt-20">
      <MemberBanner />
