...
export const metadata: Metadata = {
  title: `${ARTICLE_X.article} — ${ARTICLE_X.title}`,
  description: `Stankings Group Constitution Vol. I v${CONSTITUTION_VERSION}, ${ARTICLE_X.article}: ${ARTICLE_X.title}`,
  robots: { index: false, follow: false },
};

export default function ConstitutionArticleTenPage() {
  return (
    <div className="pt-20">
      <MemberBanner />
