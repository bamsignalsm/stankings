...
export const metadata: Metadata = {
  title: `${ARTICLE_XII.article} — ${ARTICLE_XII.title}`,
  description: `Stankings Group Constitution Vol. I v${CONSTITUTION_VERSION}, ${ARTICLE_XII.article}: ${ARTICLE_XII.title}`,
  robots: { index: false, follow: false },
};

export default function ConstitutionArticleTwelvePage() {
  return (
    <div className="pt-20">
      <MemberBanner />
