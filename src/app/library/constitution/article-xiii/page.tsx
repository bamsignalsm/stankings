...
export const metadata: Metadata = {
  title: `${ARTICLE_XIII.article} — ${ARTICLE_XIII.title}`,
  description: `Stankings Group Constitution Vol. I v${CONSTITUTION_VERSION}, ${ARTICLE_XIII.article}: ${ARTICLE_XIII.title}`,
  robots: { index: false, follow: false },
};

export default function ConstitutionArticleThirteenPage() {
  return (
    <div className="pt-20">
      <MemberBanner />
