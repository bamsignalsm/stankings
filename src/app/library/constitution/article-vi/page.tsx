...
export const metadata: Metadata = {
  title: `${ARTICLE_VI.article} — ${ARTICLE_VI.title}`,
  description: `Stankings Group Constitution Vol. I v${CONSTITUTION_VERSION}, ${ARTICLE_VI.article}: ${ARTICLE_VI.title}`,
  robots: { index: false, follow: false },
};

export default function ConstitutionArticleSixPage() {
  return (
    <div className="pt-20">
      <MemberBanner />
