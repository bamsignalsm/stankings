...
export const metadata: Metadata = {
  title: `${ARTICLE_VII.article} — ${ARTICLE_VII.title}`,
  description: `Stankings Group Constitution Vol. I v${CONSTITUTION_VERSION}, ${ARTICLE_VII.article}: ${ARTICLE_VII.title}`,
  robots: { index: false, follow: false },
};

export default function ConstitutionArticleSevenPage() {
  return (
    <div className="pt-20">
      <MemberBanner />
