...
> = {
  ...
  stanhan: {
    ...
    strengthens: ["yike", "bayright", "stankings-logistics", "stankings-hotel-and-suites", "shodis-industries"],
    dependsOn: ["yike", "bayright", "stankings-logistics", "shodis-industries"],
    boundaries: [
      "Does not operate a general marketplace",
      "Does not provide automotive services",
      "Does not issue independent financial products",
      "Does not operate hospitality venues — those belong to Stankings Hotel & Suites",
    ],
  ...
  bamsignal: {
    ...
    strengthens: ["yike", "bayright", "stankings-times", "stankings-hotel-and-suites"],
    dependsOn: [],
    boundaries: [
  ...
  "stankings-times": {
    coreCapabilities: [
      ...
      "Industry reports and investigative journalism",
      "Corporate storytelling and thought leadership",
      "Awards and executive briefing programmes",
    ],
    sharedCapabilitiesContributed: [
      "Owned media",
    ...
    dependsOn: ["bamsignal", "stankings-hotel-and-suites", "bayright"],
    boundaries: [
      "Does not operate commercial marketplaces",
      "Does not provide financial settlement",
      "Does not develop property or manufacture goods",
      "Communications arm — not a substitute for institutional legal or trust centres",
    ],
    canonReferences: ["CANON-005", "CANON-002", "CANON-014", "CANON-001"],
    platformServices: [
      "Identity & Stankings Passport",
      "Notifications",
      "Analytics & Intelligence",
    ...
    customerJourneys: [
      ...
      "Founder Interviews",
      "Leadership Series",
      "Stankings Times Awards (Stankings Legacy Live)",
      "Legacy Live media coverage",
    ],
  },
  "stankings-hotel-and-suites": {
    coreCapabilities: [
      "Hotel ownership and premium hospitality",
      "Executive suites and serviced accommodation",
      "Conference facilities and event venues",
      "Corporate accommodation and VIP hosting",
      "Leadership summits and investor meeting venues",
    ],
    sharedCapabilitiesContributed: [
    ...
    dependsOn: ["stanhan", "shodis-industries", "bayright", "stankings-logistics"],
    boundaries: [
      "NOT a real estate development company",
      "Property acquisition, development and housing remain with Stanhan Real Estate Ltd",
      "Responsible only for hospitality operations and hospitality assets",
      "Does not manufacture construction materials",
      "Does not operate marketplaces or financial products",
    ],
    canonReferences: ["CANON-005", "CANON-003", "CANON-002"],
    platformServices: [
      "Identity & Stankings Passport",
    ...
    customerJourneys: [
      "Corporate Retreat",
      "Stankings Legacy Live venue (Singles Synergy, Shared Path, Awards)",
      "Awards Venue",
      "Investor Meeting",
      "Executive Accommodation",
    ],
  ...
  "shodis-industries": {
    coreCapabilities: [
      ...
      "Regional distribution and export trade",
      "Ceramic, floor and wall tiles",
      "Sanitary ware, roofing sheets and building finishes",
    ],
    sharedCapabilitiesContributed: [
      "Factory-direct construction materials",
      "Industrial supply",
      "Export-ready production",
    ],
    strengthens: ["stanhan", "stankings-hotel-and-suites", "stankings-logistics"],
    dependsOn: ["stankings-logistics", "bayright"],
    boundaries: [
      "Does not develop or sell finished real estate",
      "Does not operate hospitality venues",
      "Does not operate marketplaces",
      "Manufacturing and industrial supply — not property development",
    ],
    canonReferences: ["CANON-005", "CANON-003", "CANON-001"],
    platformServices: [
      "Payments Infrastructure",
      "Organization Management",
      "Analytics & Intelligence",
