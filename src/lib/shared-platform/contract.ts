...
export const SHARED_CAPABILITY_CONTRACTS: SharedCapabilityContract[] = [
  {
    ...
    responsibility:
      "Portable verified identity credentials across Stankings ecosystem products; accreditation for members, guests, speakers, and VIPs.",
    nonGoals: [
      "Not a social network",
      "Not BamSignal matchmaking",
      "Not a payments wallet",
    ],
    consumers: ["BamSignal", "Yike", "BayRight", "Legacy Live", "Hotel & Suites", "Times"],
    dependsOn: ["identity"],
    docsPath: "docs/platform/runtime/PASSPORT.md",
  },
  {
    id: "identity",
