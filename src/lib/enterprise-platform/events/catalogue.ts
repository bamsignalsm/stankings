...
export const EVENT_CATALOGUE: EventDefinition[] = [
  ...
  },
  {
    ...
    domain: "passport",
    version: 1,
    description: "Reserved — Passport credential issued",
    payloadSchemaNotes: "{ credentialId, subjectId } (future)",
    compatibleEnvelopeVersions: [1],
  },
  {
    ...
    domain: "passport",
    version: 1,
    description: "Reserved — Passport credential revoked",
    payloadSchemaNotes: "{ credentialId, subjectId } (future)",
    compatibleEnvelopeVersions: [1],
  },
  {
    ...
    domain: "trust",
    version: 1,
    description: "Reserved — trust score/signal changed",
    payloadSchemaNotes: "{ subjectId, scoreDelta } (future)",
    compatibleEnvelopeVersions: [1],
  },
  {
